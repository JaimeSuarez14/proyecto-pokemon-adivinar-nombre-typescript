    ...
    >
      <div className=" p-2 rounded bg-white bg-opacity-75 space-y-3">
        ...
        <div className="space-y-4">
          <div className="w-fit mx-auto text-2xl px-5 py-3 rounded-3xl font-extrabold bg-green-700 text-white">User Login</div>
          <form action="" className="space-y-4">
            ...
            <button className="hover:scale-105 duration-150 w-fit mx-auto block text-2xl px-5 py-3 rounded-2 font-extrabold bg-gray-950 text-white"> Login</button>

          </form>
          <p className="text-gray-300 py-3 font-serif text-center italic  bg-blue-800 ">Demo User: jaime Password:admin</p>
        </div>
      </div>
    </div>
  );
